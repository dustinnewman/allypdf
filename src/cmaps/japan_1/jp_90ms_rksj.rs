...
const CID_RANGE_H: [CidRange; 171] = [
    CidRange {
        start: 32,
        end: 125,
        cid: 231,
...
pub const JAPAN_1_90MS_RKSJ_H: CMap = CMap {
    name: Cow::Borrowed(b"90ms-RKSJ-H"),
...
pub const JAPAN_1_90MS_RKSJ_V: CMap = CMap {
    name: Cow::Borrowed(b"90ms-RKSJ-V"),
    cid_system_info: CidSystemInfo {
        registry: Cow::Borrowed(ADOBE_REGISTRY),
        ordering: Cow::Borrowed(JAPAN_1),
        supplement: 2,
