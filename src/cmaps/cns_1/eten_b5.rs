...
const CODE_SPACE: [CodespaceRange; 2] = [
    [0..=0, 0..=0, 0..=0, 0..=128],
    [0..=0, 0..=0, 161..=254, 64..=254],
];

const CID_RANGE_H: [CidRange; 254] = [
    CidRange {
        start: 32,
        end: 126,
        cid: 13648,
...
pub const ETEN_B5_H: CMap = CMap {
    name: Cow::Borrowed(b"ETen-B5-H"),
...
pub const ETEN_B5_V: CMap = CMap {
    name: Cow::Borrowed(b"ETen-B5-V"),
    cid_system_info: CidSystemInfo {
        registry: Cow::Borrowed(ADOBE_REGISTRY),
        ordering: Cow::Borrowed(CNS_1),
        supplement: 0,
